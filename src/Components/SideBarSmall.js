...
export default class MenuExampleVertical extends Component {
    ...
    render() {
        ...
        return (
            <Menu vertical size="small" id='side-bar-small' className={this.props.open} fixed='left' style={{
                height: '100vh',
                borderTop: 'none',
                ...
                <Link to='/'>
                    <Menu.Item name='inbox' onClick={this.handleItemClick}
                               style={{height: '15vh', borderBottomStyle: 'dotted', borderBottomColor: 'white'}}>
                        <img src={Logo} style = {{maxHeight: '70px'}}/>
                    </Menu.Item>
                </Link>

                <Link to="/">
                    <Menu.Item name='inbox' onClick={this.handleItemClick} style={{
                        height: '10vh',
                ...
                <Link to="/rules">
                    <Menu.Item name='spam' onClick={this.handleItemClick}
                               style={{height: '10vh', borderBottomStyle: 'dotted', textAlign: 'left', color: 'white'}}>
                        大会ルール
                        <div style={{
                            position: 'absolute',
                            top: '50%',
